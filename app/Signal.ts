...
export class Signal {
    ...
    private _prevParams: any = undefined;
     ...
     * <p><strong>IMPORTANT:</strong> should be called only during signal dispatch, calling it before/after
     * dispatch won't affect signal broadcast.</p>
    ...
    private _indexOfListener(listener: Function, context: Object): number {
        ...
        let n: number = this._bindings.length;
        while (n--) {
            let cur: SignalBinding = this._bindings[n];
